            ...
            <div class="col-sm-12 mt-lg-4 col-lg-8 mx-auto mt-3">
                <div class="card">
                    <div class="card-header text-center">
                        <h1 class="text-uppercase display-4 font-weight-bold text-success">USER REGISTRATION</h1>

                        <span>Do you have an account? <a href="{{ url('login') }}">Login Here</a></span>
                    </div>
                            ...
                            <div class="form-row">
                                <div class="col-lg-6">
                                    <div class="form-group">
                                        <label for="name">Name <span class="text-danger d2">*</span></label>
                                        <input type="text" class="form-control @error('name') is-invalid @enderror"
                                            placeholder="Patient Name" name="name" value="{{ old('name') }}">
                                        @error('name')
                                ...
                                <div class="col-lg-6 col-12">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control @error('email') is-invalid @enderror"
                                            placeholder="you@gmail.com" name='email' value="{{ old('email') }}">
                                        @error('email')
                                            <span class="invalid-feedback" role="alert">
                                                <strong>{{ $message }}</strong>
                                            </span>
                            ...
                            <div class="form-row">
                                ...
                                <div class="col-lg-6 col-12">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" placeholder="071XXXXXXX" name="mobile"
                                            value="{{ old('mobile') }}">
                                    </div>
                                </div>
                            </div>
