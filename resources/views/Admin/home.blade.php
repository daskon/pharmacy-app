    ...
    <header class="sticky-top">
        <nav class="navbar navbar-expand navbar-light " style="background-color: #0aa536;">
            <div class="container-fluid font-weight-bold">
                <a href="#" class="navbar-brand d-lg-block ml-lg-5 text-white">
                    Pharmacy System
                </a>
                <div>
                ...
                <div class="row border-bottom mb-2 mt-4 bg-white">
                    <div class="col-12">
                        <div class="text-center mt-2 mb-3">
                            <span class="h5 font-weight-bold"><span class="text-success text-uppercase">Pharmacy</span>
                                <span class="text-danger">Administrator</span></span>
                        </div>
                    </div>
                </div>
                <div>
                    <div class="row bg-green mt-4">
                        <a href="{{ url('admin-dashboard') }}"
                            class="btn border-bottom col-12 text-left font-weight-bold active">
